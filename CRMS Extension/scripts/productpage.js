...
let searchField = document.getElementById('q_name_or_product_group_name_or_product_tags_name_cont');
...
if (dropdownArea && searchField){
    ...
    anchorElements.forEach(function(anchor) {
        anchor.addEventListener('click', function(event) {
            ...
            let modifiedUrl = this.href + '&q%5Bname_or_product_group_name_or_product_tags_name_cont%5D=' + searchField.value;
